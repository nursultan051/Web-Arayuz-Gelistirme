...
FXConvert, `prd.md` belgesine göre hazırlanmış statik ve istemci taraflı bir döviz dönüştürücü MVP'sidir. HTML, CSS, vanilla JavaScript, Bootstrap 5, birincil resmi para kurları için ExchangeRate-API, yedek kurlar için Frankfurter, kripto kurları için CoinGecko, `localStorage` ve service worker kullanır.
...
Bu uygulama service worker ve CDN/API istekleri kullandığı için yerel statik sunucu üzerinden çalıştırın:

```bash
cd /home/besufikad/Currency
